...
vim.keymap.set('n', '<leader>e', function() vim.fn['ToggleReadOnly']() end,
...
vim.keymap.set('n', '<leader>tv', ':vsplit +terminal <bar> doautocmd WinEnter<CR>', {remap = false, silent = true})
vim.keymap.set('n', '<leader>tb', ':split +terminal <bar> doautocmd WinEnter<CR>', {remap = false, silent = true})
